...
class AnimationPong(Animation):
    """
    Wrapper class for animating the Pong environment. The OpenAI gym package from which
    ...
    def update(self):
        ...
        if self.update_animation:
            ...
            self.env.gym_env.viewer.window.set_size(480, 630)
