...
class ControllerValueIter(Controller):
    """
    The Controller class for running a Value Iteration agent in a chosen environment. The Controller
    ...
    In the case of Value Iteration, the Controller will run exploration and greedy episodes
    ...
    def start(self):
        ...
        self.gui.add_to_listbox("VALUE ITERATION")
    ...
    def run_exploration_episode(self):
        ...
        from exploring to update the values of state using Value Iteration.
        """
    ...
    def run_greedy_episode(self):
        ...
        if self.episode_counter != self.no_of_greedy_episodes:
            ...
            if avg_reward < self.env.REWARD_THRESHOLD:
                ...
                self.gui.add_to_listbox("Completed in {0} iterations. ({1:.2f} secs)".format(self.iteration_counter, (
