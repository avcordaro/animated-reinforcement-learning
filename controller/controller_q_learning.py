...
class ControllerQLearning(Controller):
    """
    The Controller class for running a Q-Learning agent in a chosen environment. The Controller
    ...
    In the case of Q-Learning, the Controller will run a given number of episodes using the
    ...
    def start(self):
        ...
        self.gui.add_to_listbox("Q-LEARNING")
    ...
    def run_episode(self):
        """
        Runs a single episode of the environment, learning via Q-Learning on the fly. This method
