...
class ControllerREINFORCE(Controller):
    """
    ...
    def __init__(self, env, agent, gui, episodes=100):
        ...
        self.gui.update_episode_labels(0, None, 0)
    ...
    def start(self):
        ...
        self.rewards = []
        self.stop_and_reset()
        self.gui.update_episode_labels(self.episode_counter, None, self.agent.ALPHA)
        self.gui.draw_softmax_probabilities(self.agent.get_all_softmax_probabilities())
        self.gui.add_to_listbox("=============================================")
        self.gui.add_to_listbox("REINFORCE")
    ...
    def run_episode(self):
        ...
        if episode_done or self.episode_steps >= self.env.MAX_EPISODE_STEPS:
            ...
            self.episode_steps = 0
            self.agent.update_weights(self.gradients, self.rewards)
            self.gradients = []
            self.rewards = []
